...
placeholder="1-5">
<label>Email</label>
<input type="text" name="email" required placeholder="e.g. @gmail.com">
<label>phone</label>
<input type="number" name="phone" required placeholder="e.g. 01234567890">
<label>Address</label>
<input type="text" name="address" required placeholder="e.g. brgy where">
